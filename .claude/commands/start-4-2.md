---
description: "Module 4.2: Auto-Organize Hook - Auto-add frontmatter on file creation"
---

**Do this SILENTLY:**

1. Read `lesson-modules/4-automation/4.2-auto-organize-hook/CLAUDE.md` - this is your teaching script
