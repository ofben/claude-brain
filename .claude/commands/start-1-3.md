---
description: "Module 1.3: Claude Code Essentials - First interactions, reading vault files"
---

**Do this SILENTLY:**

1. Read `lesson-modules/1-foundations/1.3-claude-code-essentials/CLAUDE.md` - this is your teaching script
